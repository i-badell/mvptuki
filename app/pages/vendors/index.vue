...
watch(
  [pending, vendors],
  ([isPending, list]) => {
    if (!isPending && list.length === 1) {
      navigateTo(`/vendors/${list[0]?.id}`, { replace: true });
    }
  },
  { immediate: true },
);
  ...
  <div id="TESTING">
    ...
    <template v-else>
      ...
      <div class="px-5 pt-5 pb-0">
        <p
          class="font-bold uppercase text-red mb-1"
          style="font-size: 10px; letter-spacing: 2px"
        >
          {{ festival?.name ?? "Festival" }} · {{ new Date().getFullYear() }}
        </p>
        <h1
          class="font-display text-black leading-[0.9]"
          style="font-size: 38px; letter-spacing: 2px"
        >
          FOOD<br /><span
            class="font-serif italic text-red not-italic"
            style="font-size: 28px; font-style: italic"
            >Trucks</span
          >
        </h1>
        <p class="text-gray-500 mt-1.5" style="font-size: 12px">
          {{ vendors.length }} puestos ·
          {{ festival?.description ?? "Hoy en el festival" }}
        </p>
      </div>
      ...
      >
        <button
          ...
          :class="
            activeTab === 'list' ? 'bg-black text-white' : 'text-gray-500'
          "
        ...
        >
          <svg
            ...
            viewBox="0 0 24 24"
            fill="none"
            :stroke="activeTab === 'list' ? 'white' : '#888'"
            stroke-width="2"
        ...
        >
          <svg
            ...
            viewBox="0 0 24 24"
            fill="none"
            :stroke="activeTab === 'map' ? 'white' : '#888'"
            stroke-width="2"
            stroke-linecap="round"
      ...
      <div v-if="activeTab === 'list'" class="px-5 flex flex-col gap-2.5 pb-4">
        ...
        <NuxtLink
          ...
          :class="
            vendor.status === 'paused' ? 'opacity-60 pointer-events-none' : ''
          "
          :style="{
            border: '1.5px solid #111111',
        ...
        >
          ...
          >
            ...
            <!-- Emoji -->
            <span
              class="relative z-10 filter drop-shadow-sm"
          ...
          <div class="px-4 py-3">
            ...
            <div class="flex items-start justify-between mb-1.5">
              <p
                class="font-serif font-bold text-black"
            ...
            <!-- Featured item tags -->
            <div
              v-if="vendor.menu_items.length"
              class="flex gap-1.5 flex-wrap mb-3"
            >
              <span
              ...
              <div class="flex items-center gap-2.5">
                ...
                >
                  <span
                    ...
                    :class="
                      vendor.status === 'active' ? 'bg-success' : 'bg-gray-400'
                    "
                ...
                <span
                  ...
                  style="
                    ...
                    box-shadow: 2px 2px 0 #aa1f1f;
                  "
                  :style="
                    vendor.status === 'paused'
                      ? 'border-color: #d0d0d0; box-shadow: 2px 2px 0 #d0d0d0;'
                      : 'border-color: #aa1f1f;'
                  "
                >
                  {{
        ...
        >
          ...
          <div class="relative" style="aspect-ratio: 350/300; width: 100%">
            ...
            >
              ...
              />
              <!-- Vendor pins -->
              <g v-for="(vendor, i) in vendors.slice(0, 5)" :key="vendor.id" />
          ...
          <!-- Map legend -->
          <div
            class="flex flex-wrap gap-3.5 px-4 py-3"
            style="border-top: 1.5px solid #e8e8e8"
          >
            <div
              class="flex items-center gap-1.5 font-semibold text-gray-500"
        ...
        <div class="flex flex-col gap-2 mt-3.5">
          ...
          >
            ...
            <div
              ...
              :style="{
                background:
                  vendor.status === 'paused' ? '#888878' : cardColor(vendor),
                width: '28px',
                height: '28px',
            ...
            <!-- Wait -->
            <span
              class="font-bold text-black flex-shrink-0"
              style="font-size: 10px"
            >
              {{
                vendor.status === "paused"
                  ? "Cerrado"
                  : vendor.requires_prep
                    ? "~10 min"
                    : "~5 min"
              }}
            </span>
